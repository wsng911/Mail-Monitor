...
def main():
    ...
    gmail_guide = (
        ...
        "▌ Pub/Sub Topic\n"
        "名称：gmail\\-push\n"
        "完整路径：projects/mail\\-monitor\\-493615/topics/gmail\\-push\n"
        "发布者权限：gmail\\-api\\-push@system\\.gserviceaccount\\.com\n\n"
        "▌ Pub/Sub 订阅\n"
        "名称：gmail\\-push\\-sub\n"
        "类型：推送\n"
        ...
        "▌ Search Console 域名验证\n"
        "验证文件：/google883877c5c8e86eea\\.html\n"
    ...
    outlook_guide = (
        ...
        "▌ API 权限\n"
        "Mail\\.Read / Mail\\.ReadWrite / User\\.Read / offline\\_access\n"
        "允许公共客户端流：已启用\n\n"
